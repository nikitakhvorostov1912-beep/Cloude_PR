...
│   └── ecc/              <- 48 команд ECC (/ecc:plan, /ecc:tdd, /ecc:claw...)
│
├── skills/               <- Скиллы (277 шт.)
│   ├── [custom]/         <- 150 кастомных скиллов
│   ├── ecc/              <- 94 скилла ECC
│   └── marketing/        <- 33 маркетинговых скилла
│
├── rules/                <- Правила кодинга (49 файлов)
...
*Обновлено: 2026-03-14 | Агентов: 42 | Скиллов: 277 | Правил: 49 | Команд: 48*
