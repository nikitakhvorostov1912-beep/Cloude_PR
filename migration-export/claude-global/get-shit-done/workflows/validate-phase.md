...
```
Task(
  prompt="Read C:/Users/nikit/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/nikit/.claude/get-shit-done/templates/VALIDATION.md`
